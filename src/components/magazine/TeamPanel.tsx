...
const TEAM: Member[] = [
  {
    ...
    role: "Founder, Tech Lead, Co-Editor",
    bio: "Riddhiman founded Probashferry to give the Bengali diaspora a magazine of its own. He builds the platform, curates the photography section, and co-edits every issue to make sure it feels like home.",
    image: null,
  },
  {
    id: "abhipsha",
    ...
    bio: "Abhipsha shapes the visual language of every issue. From cover art to layout, she brings a deep love for Bengali folk aesthetics into a modern design sensibility. She also reviews all art submissions.",
    image: null,
  },
  {
    id: "ritoja",
    ...
    bio: "Ritoja keeps the wheels turning behind every issue. From coordinating contributors to editing prose and poetry, her meticulous attention to detail ensures every piece meets the highest standards.",
    image: null,
  },
  {
    id: "srijan",
    ...
    bio: "Srijan connects Probashferry with voices across the diaspora. He manages outreach to new contributors, oversees Bengali-language submissions, and brings in guest columns that broaden every issue.",
    image: null,
  },
  {
    id: "pratyusha",
    ...
    bio: "Pratyusha builds the Probashferry community across Instagram and Facebook. From teasers and countdowns to reader engagement, she makes sure the magazine reaches every corner of the diaspora.",
    image: null,
  },
];
