...
- **TeamPanel roles** — current hardcoded bios/roles in `TeamPanel.tsx` are outdated. Correct roles: Ritoja (Editor-in-Chief), Srijan (Outreach Manager), Pratyusha (Social Media & Community Manager), Abhipsha (Art & Creativity Director), Riddhiman (Founder, Tech Lead, Co-Editor).
